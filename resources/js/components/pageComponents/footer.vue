...
// Create a computed property to get the current year
...
<template>
    <footer class="w-full py-14">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div
                class="max-w-3xl mx-auto flex flex-col justify-center items-center"
            >
                <div
                    class="w-[100%] max-w-[600px] bg-gray-300 h-[1px] mb-10 item-center"
                ></div>
                <div class="flex space-x-10 justify-center items-center mb-10">
                    <a
                        href="#"
                        class="block text-gray-500 transition-all duration-500 hover:text-green-500"
                    >
                        <svg
                ...
                <span class="text-lg text-gray-500 text-center block">
                    ©<a href="#">ADAS-Tech</a> {{ currentYear }}, All rights
                    reserved.
                </span>
            </div>
        </div>
